...
public class VehiclesParser {
    private final static String apiKey = BuildConfig.BUS_API_KEY;
    OkHttpClient client = new OkHttpClient();
    private XmlPullParser parser;

    public void getData(Consumer<Pair<List<Vehicle>, Metadata>> callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            IOException {
                ...
                callback.accept(new Pair<>(vehicles, metadata));
            }
        });
    }
}
